 ...
 */
public class ProxyStack extends BaseHttpStack {
     ...
     */
    public ProxyStack(UrlRewriter urlRewriter) {
     ...
     */
    public ProxyStack(UrlRewriter urlRewriter, SSLSocketFactory sslSocketFactory) {
